...
class _ProfilePageState extends State<ProfilePage> {
  ...
  Future<void> _login() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(const SnackBar(content: Text('Вы успешно вошли в профиль!')));
      _checkUser();
  ...
  Future<void> _updateProfile() async {
    ...
    try {
      ...
      if (_user!.email != _emailController.text.trim()) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          const SnackBar(content: Text('Данные профиля успешно обновлены!')),
        );
      }
      ...
      _showError('Ошибка обновления профиля. Попробуйте ещё раз.');
    }
  }
                      ...
                      builder: (context) {
                        return AlertDialog(
                          ...
                          content: TextField(
                            ...
                            decoration: const InputDecoration(labelText: 'URL фото профиля'),
                          ),
                          actions: [
                            TextButton(
                              onPressed: () {
