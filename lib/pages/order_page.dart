...
class _OrderPageState extends State<OrderPage> {
  ...
  Future<void> _submitOrder() async {
    ...
    try {
      ...
      ScaffoldMessenger.of(context).showSnackBar(
        SnackBar(content: Text('Ошибка оформления покупки: $e')),
      );
    }
  }
        ...
        child: Column(
          children: [
            TextField(
              ...
              decoration: const InputDecoration(labelText: 'Адрес для доставки носков'),
            ),
            const SizedBox(height: 16),
            ListTile(
              title: Text(_selectedDate == null
                  ? 'Выберите дату доставки носков'
                  : 'Дата доставки носков: ${_selectedDate.toString().split(' ')[0]}'),
            ...
            ListTile(
              title: Text(_selectedTime == null
                  ? 'Выберите время доставки носков'
                  : 'Время доставки носков: ${_selectedTime?.format(context)}'),
