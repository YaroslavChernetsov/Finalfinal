          ...
          return FutureBuilder<QuerySnapshot>(
            ...
            builder: (context, snapshot) {
              if (snapshot.connectionState == ConnectionState.waiting) {
                ...
                return const Center(child: Text('У вас нет оформленных покупок.'));
              }
              ...
              return ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  return ListTile(
                    title: Text('Покупка от $userName'),
                    subtitle: createdAt != null
                        ? Text('Дата оформления покупки: ${createdAt.toLocal()}')
                        : const Text('Дата оформления покупки: неизвестно'),
                    trailing: IconButton(
